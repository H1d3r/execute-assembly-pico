...
runner: dirs libtcg pico crystal-palace/ loader.spec src/runner.c
	...
	java -Dcrystalpalace.verbose=false -jar crystal-palace/crystalpalace.jar buildPic ./loader.spec x64 out/runner.bin
...
tester: dirs libtcg libcpltest runner crystal-palace/ loader.spec src/runner.c
	...
	java -Dcrystalpalace.verbose=false -jar crystal-palace/crystalpalace.jar buildPic ./tester.spec x64 out/tester.bin
